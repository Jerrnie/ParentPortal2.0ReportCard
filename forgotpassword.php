...
if (!isset($_GET['forgotpass'])) {
  ...
  if (isset($_GET['forgotpass'])) {
    ...
    $forgotNumber =  cleanthis($_POST['forgotNumber']);
          ...
          $sql = "sELECT  a.*, b.userID,  b.password,  b.sqAnswer  FROM tbl_securityquestions AS a INNER JOIN tbl_parentuser AS b ON b.sqID = a.sqID where mobile = ".$forgotNumber." && (b.usertype = 'P') LIMIT 1 LIMIT 1";
