...
if (isset($_POST["btn-submit"])) {
  ...
  if (empty($studinfo)) {
    ...
    ('" .  $user_check . "', '" .  $userFname . "', '" .  $userLname . "', 'Exports attendance of all students from ' '" .  $_POST['subfrom'] . " ' 'to ' '" . $_POST['subto'] . "','" . $date . "','" . $schoolYearID . "')";
      mysqli_query($conn, $insertauditQuery);
    } elseif ($_POST['r1'] == "personnel") {
      $date = date('Y-m-d H:i:s');
      $insertauditQuery = "Insert into tbl_audittrail (userID, fname, lname, activity, activitydate, schoolYearID) Values  
    ('" .  $user_check . "', '" .  $userFname . "', '" .  $userLname . "', 'Exports attendance of all personnel from ' '" .  $_POST['subfrom'] . " ' 'to ' '" . $_POST['subto'] . "','" . $date . "','" . $schoolYearID . "')";
      mysqli_query($conn, $insertauditQuery);
    }
