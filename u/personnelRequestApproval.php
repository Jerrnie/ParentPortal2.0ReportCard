...
<head>
  ...
  <title>Pending Approval | Parent Portal</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Default box -->
          ...
          $sql = "select A.RequestRemarks, A.DateTimeRequested, A.status,U.fullName as ParentName,
                  DAte(S.DateSchedule) as DateSchedule, S.occupied, S.WebLink, S.SchedTimeFrom, S.SchedTimeTo,
                  P.Personnel_code,
                  concat(P.Fname,' ', P.Mname,' ',P.Lname) as PersonnelName,P.Position,A.Appoint_Id,A.PersonnelSched_Id,A.ReadTag
                  ...
                  where A.status ='Pending' and S.Personnel_Id = $personnelID 
          ...
          echo"<tr class='tRow' id='row".$ctr."' style='background-color:#ebebeb;'>";
                  ...
                  // echo"</h6></td>";
                  echo"<td><h6>";
                  echo $DateTimeRequested;
                  echo"</h6></td>";
               
                    echo'   <td class="text-center">';
                    echo'       <a class="btn btn-primary btn-sm " title="Aprrove or Deny" href="personnelviewRequestApproval.php?page='.$row[12].'&stat='.$row[2].'">';
                    echo'           <i class="fas fa-cog" >';
                    echo'           </i>';
                    echo'           ';
                    echo'       </a>';
                    echo'   </td>';
