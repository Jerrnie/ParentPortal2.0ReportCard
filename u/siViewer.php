        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="siView.php">View all Student Profile</a></li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $fullname?>'s Information</h3>
...
echo "<br><br>";
                            echo"<input type='hidden' value=?><iframe src='SI/".$files2[$matchIndex]."';  name='inputfile' style='margin:0; padding:0; width:100%; height:800px; border:none; overflow:hidden;' scrolling='no' onload='AdjustIframeHeightOnLoad'> </iframe> <?php; >";
                             echo "</div>";
                                    }
                                    else{
                                      header('Location: siView.php');
