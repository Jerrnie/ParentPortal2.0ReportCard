  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Default box -->
          ...
          CONCAT(B.lastName,', ',B.firstName,' ',B.middleName) AS StudentName,A.Status,A.Reason
          ...
          WHERE B.userID = '".$user_check."' AND (A.status ='4' or A.Status ='3' or A.status ='2') 
          ...
          echo"<tr class='tRow' id='row".$ctr."'>";
                  ...
                  if ($Status3 == '4') {
                    echo '<td class="text-center"><h4><span class="badge badge-danger" style ="font-weight: normal; width:110px;">Denied</span></h4></td>';                    
                  }elseif ($Status3 == '3') {
...
if (isset($_REQUEST['ARA'])) {
  $message = "Appointment request has been Approved!";
  displayMessage("success", "Success", $message);
}
if (isset($_REQUEST['ARD'])) {
  $message = "Appointment request has been Deny!";
  displayMessage("success", "Success", $message);
}
