          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="addPersonnel.php">Add Personnel</a></li>
                <li class="breadcrumb-item active">View All Personnel</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <p>
              <a href="?" type="bbutton" class="btn btn-success add-button buttonDelete ">
          ...
          <div class="card-body" style="width: 100%;">
            <table id="example1" class="table table-bordered" style="table-layout: fixed; width: 100%;">
              ...
              <tbody>
                ...
                $sql = "select * FROM tbl_Personnel ORDER BY Personnel_Id";
                ...
                if (mysqli_num_rows($result1) > 0) {
                  while ($row = mysqli_fetch_array($result1)) {
                    ...
                    echo '       <a class="btn btn-info btn-sm " title="View Schedule" href="allPersonnelSchedule.php?page=' . $row[0] . '">';
                    echo '           <i class="fas fa-eye" >';
                    echo '           </i>';
                    echo '           ';
                    echo '       </a>';
                    //echo'     <a class="btn btn-success btn-sm " title="Add Schedule"  href="addSchedule.php?page='.$row[0].'">';
                    //echo'           <i class="fas fa-calendar-plus">';
                    //echo'           </i>';
                    //echo'           ';
                    //echo'      </a>';
                    echo '        <a href="#" class="btn delete btn-sm btn-danger" title="Delete Personnel" id="delete' . $ctr . '" rowIdentifier="row' . $ctr . '"  value="' . $row[0] . '" >';
