...
echo "<br><br>";
                            echo"<input type='hidden' value=?><iframe src='RC/".$files2[$matchIndex]."#toolbar=0&navpanes=0&scrollbar=0';  name='inputfile' style='margin:0; padding:0; width:100%; height:800px; border:none; overflow:hidden;' scrolling='no' onload='AdjustIframeHeightOnLoad'> </iframe> <?php; >";
                             echo "</div>";
                                    }
                                    else{
