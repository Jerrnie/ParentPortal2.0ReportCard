    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><?php echo $Fname, ' ', $Lname ?> Schedule</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item active">Personnel Schedule</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          where a.Personnel_Id ='" . $_GET['page'] . "' ORDER BY a.SchedTimeFrom ASC";
                ...
                if (mysqli_num_rows($result1) > 0) {
                  while ($row = mysqli_fetch_array($result1)) {
                    ...
                    echo '       <a class="btn btn-primary btn-sm" title="Edit Schedule" href="viewSchedule.php?page=' . $row[0] . '">';
