...
if (!isset($user_check) && !isset($password_check)) {
  ...
  if (!isset($_GET['page'])) {
  header('Location: reportCardView.php');
}
...
<head>
  ...
  <title>Report Card's View | Parent Portal</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Card's View</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><a href="reportCardView.php">View all Report Card</a></li>
              <li class="breadcrumb-item active">Report Card's View</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo  $fullname?>'s Report Card</h3>
...
echo "<a href='rcDownloader.php?file=".$files2[$matchIndex]."'>Download Report Card</a>";
echo "<br><br>";
                            echo"<input type='hidden' value=?><iframe src='RC/".$files2[$matchIndex]."';  name='inputfile' style='margin:0; padding:0; width:100%; height:800px; border:none; overflow:hidden;' scrolling='no' onload='AdjustIframeHeightOnLoad'> </iframe> <?php; >";
                             echo "</div>";
                                    }
                                    else{
                                      header('Location: reportCardView.php');
