...
if (isset($_GET['page'])) {
  ...
  header("location: viewRequestApproval.php");
}
...
<body class="hold-transition sidebar-mini">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="requestApproval.php">Appointment Request</a></li>
                  <li class="breadcrumb-item active">Approve or Deny</li>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3">
                        <div class="form-group">
                          ...
                          <input disabled="true" value="<?php echo $DateSchedule ?>" name="pcode" type="date" class="form-control" placeholder="">
                        </div>
                      </div>
                      <div class="col-lg-3">
                        <div class="form-group">
                          <label class="unrequired-field">Start Time</label>
                          <input disabled="true" value="<?php echo $SchedTimeFrom ?>" name="fname" id="fname" type="time" maxlenght="60" class="form-control" placeholder="">
                        </div>
                      </div>
                      <div class="col-lg-3">
                        <div class="form-group">
                          <label class="unrequired-field">End Time</label>
                          <input disabled="true" value="<?php echo $SchedTimeTo  ?>" name="fname" id="fname" type="time" maxlenght="60" class="form-control" placeholder="">
                        </div>
                      </div>
                      <div class="col-lg-3">
                        <div class="form-group">
                          <label class="unrequired-field">Date Requested</label>
                          <input disabled="true" value="<?php echo $DateTimeRequested  ?>" name="DateTimeRequested" id="DateTimeRequested" type="date" maxlenght="60" class="form-control" placeholder="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input disabled="true" value="<?php echo $ParentName  ?>" name="ParentName" id="ParentName" type="text" class="form-control" placeholder="">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="unrequired-field">Personnel Name</label>
                          <input disabled="true" value="<?php echo $PersonnelName  ?>" name="PersonnelName" type="text" class="form-control" placeholder="">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input disabled="true" value="<?php echo $RequestRemarks  ?>" name="RequestRemarks" type="text" class="form-control" placeholder="">
                        </div>
                      </div>
                    </div>
  ...
  - ' . SCHOOL_ABV . ' ';
      ...
      $insertauditQuery = "Insert into tbl_audittrail (userID, fname, lname, activity, activitydate, schoolYearID) Values  ('" .  $user_check . "', '" .  $userFname  . "', '" .  $userLname  . "', 'Approves appointment request of ' '" . $ParentName . " ' 'to ' '" . $PersonnelName . " ' 'on ' '" . $DateSchedule . " ' 'from: ' '" . $SchedTimeFrom . " ' 'to: ' '" . $SchedTimeTo . " ' 'with a purpose of ' '" . $RequestRemarks . "', '$date','" . $schoolYearID . "' )";
      ...
      header('Location: requestAppointmentHistory.php?RAS');
    }
  } else {
    ...
    - ' . SCHOOL_ABV . '';
        ...
        $date = date('Y-m-d H:i:s');
        $insertauditQuery = "Insert into tbl_audittrail (userID, fname, lname, activity, activitydate, schoolYearID) Values  ('" .  $user_check . "', '" .  $userFname  . "', '" .  $userLname  . "', 'Denies appointment request of ' '" . $ParentName . " ' 'to ' '" . $PersonnelName . " ' 'on ' '" . $DateSchedule . " ' 'from: ' '" . $SchedTimeFrom . " ' 'to: ' '" . $SchedTimeTo . " ' 'with a purpose of ' '" . $RequestRemarks . "', '$date', '" . $schoolYearID . "')";
        mysqli_query($conn, $insertauditQuery);
        ...
        header('Location: requestAppointmentHistory.php?ARD');
      }
    }
  }
          ...
          $.ajax({
            ...
            success: function() {
              Swal.fire({
                ...
                document.location.href = 'viewAllPersonnel.php';
              });
