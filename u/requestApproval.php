    ...
    <section class="content">
      ...
      <!-- Default box -->
          ...
          $sql = "select A.RequestRemarks, A.DateTimeRequested, A.status,U.fullName as ParentName,
                  ...
                  P.Personnel_code,
                  concat(P.Lname,', ',P.Fname,' ', P.Mname) as PersonnelName,P.Position,A.Appoint_Id
                  ...
                  AND A.schoolYearID = '" . $schoolYearID . "' Order by DateSchedule DESC;";
          ...
          echo"<tr class='tRow' id='row".$ctr."'>";
                  ...
                  echo"</h6></td>";
                    ...
                    echo'       <a class="btn btn-primary iconsize" title="Approve or Deny" href="viewRequestApproval.php?page='.$row[12].'&stat='.$row[2].'">';
                    echo'           <i class="d-flex justify-content-center fas fa-cog">';
                    echo'           </i>';
                    echo'           ';
                    echo'       </a>';
                    echo'   </td>';
