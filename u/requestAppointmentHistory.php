...
<?php
  ...
  require '../include/config.php';
  $page = "requestAppointmentHistory";
    ...
    <section class="content">
      ...
      <!-- Default box -->
          ...
          $sql = "select A.RequestRemarks, A.DateTimeRequested, A.status,U.fullName as ParentName,
                  ...
                  P.Personnel_code,
                  concat(P.Lname,', ',P.Fname,' ', P.Mname) as PersonnelName,P.Position,A.Appoint_Id,A.Reason
                  ...
                  where A.schoolYearID = '" . $schoolYearID . "' AND
                  A.status ='Approved' or A.status ='Denied'
