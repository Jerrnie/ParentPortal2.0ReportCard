...
<?php
  ...
  $page = "PersonnelRequestAppointmentInformation";
...
<div class="container-fluid ">
   ...
   <div class="card">
          ...
          if ($Status3 == '2') {
            echo '<td class="text-center"><h4><span class="badge badge-success" style ="font-weight: normal; width:110px;">Approved</span></h4></td>';
          } elseif($Status3 == '3'){
...
if(isset($_POST['btnCancel'])){
    ...
    $query = mysqli_query($conn, "UPDATE tbl_ParentAttendAppointment SET  Status='3' WHERE RequestAppointment_Id='" . $requestID . "'");
    mysqli_query($conn, $query);

    $query1 = mysqli_query($conn, "UPDATE tbl_PersonnelRequestAppointment SET  Status='3' WHERE RequestAppoint_Id ='" . $requestID . "'");
    mysqli_query($conn, $query1);

    header('Location: PersonnelRequestAppointmentInformation.php?page='.$requestID);
