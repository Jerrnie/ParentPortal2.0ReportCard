...
<head>
  ...
  <title>Appointment Schedule | Parent Portal</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1> <?php echo $Fname, ' ', $Mname, ' ', $Lname, '\'s ' ?>Appointment Schedule</h1>
            </div>
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <p>
              <a href="?page=<?php echo $userID2 ?>" type="button" class="btn btn-success add-button buttonDelete "> <span class="fa fa-undo  ref-btn ref-btn2" aria-hidden="true">&nbsp&nbsp</span>Refresh
              </a>&nbsp&nbsp
          ...
          where a.Personnel_Id ='" . $_GET['page'] . "' 
          AND schoolYearID = '" . $schoolYearID . "' ORDER BY a.DateSchedule DESC";
                ...
                if (mysqli_num_rows($result1) > 0) {
                  while ($row = mysqli_fetch_array($result1)) {
                    ...
                    echo '       <a class="btn btn-primary btn-sm" title="Edit" href="viewSchedule.php?page=' . $row[0] . '">';
                    echo '           <i class="fas fa-pencil-alt">';
                    echo '           </i>';
                    echo '           ';
                    echo '       </a>';
                    echo '        <a href="#" class="btn delete btn-sm btn-danger" title="Delete" id="delete' . $ctr . '" rowIdentifier="row' . $ctr . '"  value="' . $row[0] . '" >';
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input value="<?php echo $Fname, ' ', $Mname, ' ', $Lname ?>" name="name" id="name" type="text" class="form-control" maxlength="50" placeholder="" readonly>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
                    <label class="unrequired-field">Position</label>
                    <input value="<?php echo $Position ?>" name="position" id="position" type="text" class="form-control" maxlength="50" placeholder="" readonly>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input required="true" value="<?php if (isset($_POST['DateSchedule'])) {
                                                    echo $_POST['datesched'];
                                                  } ?>" type="text" name="datesched1" class="form-control" readonly="true" id="datesched1">
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input required="true" value="<?php if (isset($_POST['DateSchedule'])) {
                                                    echo $_POST['datesched'];
                                                  } ?>" type="text" name="datesched2" class="form-control" readonly="true" id="datesched2">
                  </div>
                </div>
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    WHERE
        t.n <= TIMESTAMPDIFF(DAY, '" . $newDate1 . "', '" . $newDate2 . "');";
            ...
            $checkRecord1 = mysqli_query($conn, "SELECT Fname, Mname, Lname FROM tbl_Personnel WHERE Personnel_Id = '" .  $Personnel_Id . "' ");
            ...
            $insertauditQuery = "Insert into tbl_audittrail (userID, fname, lname, activity, activitydate,schoolYearID) Values  ('" .  $user_check . "', '" .  $userFname  . "', '" .  $userLname  . "', 'Creates a schedule for ' '" .  $fname  . " ' '" .  $mname  . " ' '" .  $lname  . "', '$date','" . $schoolYearID . "')";
            mysqli_query($conn, $insertauditQuery);

            header('Location: allPersonnelSchedule.php?addSched&page=' . $Personnel_Id);
          }
        }
      }
    }
