          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $fullname?>'s Statement of Account</h3>
...
echo "<br><br>";
                            echo"<input type='hidden' value=?><embed src='SOA/".$files2[$matchIndex]."#toolbar=0&navpanes=0&scrollbar=0';  name='inputfile' style='margin:0;  padding:0; width:100%; height:800px; border:none; overflow:hidden;' scrolling='no' onload='AdjustIframeHeightOnLoad'>  <?php; >";
                             echo "</div>";
                                    }
                                    else{
                                      header('Location: soaViewer.php');
                                    }
?></div>
</div>
</div>
