...
require '../include/config.php';
$page = "viewAllPersonnelAttendance";
...
<head>
  ...
  <title>Personnel Attendance | Parent Portal</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Personnel Attendance</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item active">Personnel Attendance</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
          ...
          <div class="card-body" style="width: 100%;">
              <table id="example1" class="table table-bordered" style="table-layout: fixed; width: 100%;">
                ...
                <tbody>
                <?php
                $sql = "SELECT b.Lname,b.Fname,b.Mname,a.TimePunch,a.Mode,b.Personnel_code 
                FROM tbl_Attendance AS a, tbl_Personnel AS b WHERE b.Personnel_code=a.StudentId AND a.isStudent = '2' AND b.schoolYearID = '" . $schoolYearID . "' ORDER BY a.TimePunch DESC";
