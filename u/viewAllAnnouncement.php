...
<head>
  ...
  <title>View All Announcement | Parent Portal</title>
        ...
        <div class="card">
          <div class="card-header">
            <p>
              ...
              <a href="publishA.php" type="button" class="btn btn-primary add-button">
                <span class=" fa fa-plus-square">&nbsp&nbsp</span>New Announcement
              </a>
            </p>
          </div>
          <!-- /.card-header -->
          <div class="card-body" style="width: 100%;">
            <table id="example1" class="table table-bordered" style="table-layout: fixed; width: 100%;">
              ...
              <tbody>
                ...
                $sql = "SELECT * FROM tbl_announcement where schoolYearID = '" . $schoolYearID . "' ORDER BY dateStart DESC";
                ...
                if (mysqli_num_rows($result1) > 0) {
                  while ($row = mysqli_fetch_array($result1)) {
                    ...
                    $status = '';
                    $sortformat1 = strtotime($startDate);
                    $sortformat2 = strtotime($endDate);
                    ...
                    echo $row[2];
                    echo "</h6></td>";
                    echo "<td data-sort='".$sortformat1."'><h6>";
                    echo $startDate;
                    echo "</h6></td>";
                    echo "<td data-sort='".$sortformat2."'><h6>";
                    echo $endDate;
                    echo "</h6></td>";
                    if (date("Y/m/d H:i:s") < date_format(date_create($row[6]), "Y/m/d H:i:s")) {
                      echo '<td class="text-center" title="Your information reach the school"><h3><span class="badge badge-success" style ="font-weight: normal; width:110px;">Scheduled</span></h3></td>';
                      $status = '3';
                      ...
                      echo '<td class="text-center" title="Your information has been save."><h3><span class="badge badge-info" style ="font-weight: normal; width:110px;">Posted</span></h3></td>';
                      $status = '3';
                      $status = '3';
                    } else {
                      echo '<td class="text-center" title="Press submit to confirm your registration."><h3><span id="badge' . $ctr . '" class=" badge badge-danger" style ="font-weight: normal; width:110px;">Expired</span></h3></td>';
                      $status = '3';
                    }

                    if ($status == 1 || $status == 2) {
                      echo '   <td class="text-center">';
                      echo '       <a class="btn btn-primary btn-sm " title="View" href="editAnnouncement.php?page=' . $row[0] . '">';
                      ...
                      echo "</td>";
                      echo '   <td class="text-center">';
                      echo '       <a class="btn btn-primary btn-sm " title="View / Edit" id="veButton' . $ctr . '"  href="editAnnouncement.php?page=' . $row[0] . '">';
