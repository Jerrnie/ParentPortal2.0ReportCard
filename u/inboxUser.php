                                                                ...
                                                                if (in_array($row[0],  $addedInbox)) {
                                                                    ...
                                                                    if ($_SESSION['userID'] == $sID) {
                                                                        if (in_array($rID,  $addUser)) {
                                                                            ...
                                                                            echo "<tr>";
                                                                            echo '<td align="left"> <h5> <a href="readmail2.php?page=' . $encodeThis1 . '&id=' . $encodeThis3 . '&hash='.$encodeThis5.'">';
                                                                            echo  $row[4];
                                                                            echo "</h5></td>";
                                                                        ...
                                                                        if (in_array($sID, $addUser1)) {
                                                                            ...
                                                                            echo "<tr>";
                                                                            echo '<td align="left"> <h5> <a href="readmail2.php?page=' . $encodeThis1 . '&id=' . $encodeThis2 . '&hash='.$encodeThis4.'">';
                                                                            echo $row[3];
                                                                            echo "</h5></td>";
