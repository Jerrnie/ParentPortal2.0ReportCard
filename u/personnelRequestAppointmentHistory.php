...
<?php
  ...
  require '../include/config.php';
  $page = "personnelRequestAppointmentHistory";
...
<head>
  ...
  <title>Approval History | Parent Portal</title>
    ...
    <section class="content">
      ...
      <!-- Default box -->
          ...
          $sql = "select A.RequestRemarks, A.DateTimeRequested, A.status,U.fullName as ParentName,
                  ...
                  P.Personnel_code,
                  concat(P.Fname,' ', P.Mname,' ',P.Lname) as PersonnelName,P.Position,A.Appoint_Id,A.PersonnelSched_Id,A.Reason
                  ...
                  (A.status ='Approved' or A.status ='Denied') and S.Personnel_Id = $personnelID
...
if (isset($_REQUEST['ARD'])) {
  $message = "Request has been denied!";
  displayMessage("success", "Denied", $message);
}
