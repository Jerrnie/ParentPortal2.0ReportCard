...
foreach($_GET as $loc=>$item)
    $_GET[$loc] = base64_decode(urldecode($item));
        ...
        $var1 = md5($salt.$_GET['page'].$_GET['id']);
            ...
            if ($result) {
                ...
                WHERE a.ReceiverUser_Id = '" . $_SESSION['userID'] . "' AND b.schoolYearID = '" . $schoolYearID . "'
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-header">
                                    ...
                                    <!-- <h4> Subject: <?php echo $Sname ?></h4> -->
                                    <!-- <h6> From: <?php echo $fname, ' ', $lname ?><h6> -->
                                    ...
                                    <div class="mailbox-read-message">
                                        <!-- <textarea readonly value="" name="htmlcode" class="textarea" style="resize: none; width: 100%; height: 200px; font-size: 14px; line-height: 18px; border:1px solid #dddddd ; padding: 10px;"> <?php echo $message ?></textarea> -->
                                        <?php
                                        $sql = "SELECT a.Subject_Id, a.Message_Id, 
                                        ...
                                        WHERE a.Subject_Id = '" . $_GET['page'] . "' AND d.schoolYearID = '" . $schoolYearID . "'
                                        AND (a.ReceiverUser_Id = '" .  $_SESSION['userID'] . "' 
                                        OR a.SenderUser_Id = '" .  $_SESSION['userID'] . "') 
                                ...
                                <div class="card-footer bg-white">
                                    ...
                                    <!-- <div class="form-group">
                                            <input readonly value="<?php echo $sID ?>" name="to" id="to" type="text" class="form-control" placeholder="To:">
                                        </div> -->
    ...
    if (isset($_POST['send'])) {
     ...
     VALUES
     (
      '" . $user_check . "','" . $_GET['id'] . "','" . $no . "','" .  $htmlcode . "','" . $date . "', '" . $no . "','" . $schoolYearID . "')";
        ...
        //         $insertquery2 = "Insert into tbl_MessageSubject (Message_Id, SubjectName) 
        // Values
        // ('" . $msgId . "', '" . $Sname . "')";
    ...
    ('" . $_GET['page'] . "', '" .  $msgId . "','" . $user_check . "','" . $_GET['id'] . "')";
        ...
        header(
            'Location: readmail2.php?replySent&page=' . $encodeThis1 . '&id=' . $encodeThis2 . '&hash='.$encodeThis4
        );
    }
