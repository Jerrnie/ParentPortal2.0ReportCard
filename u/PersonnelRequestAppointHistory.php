...
<?php
  ...
  require '../include/config.php';
  $page = "PersonnelRequestAppointHistory";
  ...
  $query = "select * from tbl_Personnel as a,tbl_parentuser as b where a.Personnel_Id = b.pID AND b.userID ='".$user_check."'";
...
<head>
  ...
  <title>Request Appointment History | Parent Portal </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Request Appointment History</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Request Appointment History</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <!-- Default box -->
          ...
          $sql = "SELECT DISTINCT CONCAT(D.Lname,', ',D.Fname,' ',D.Mname) AS PersonnelName, 
          D.Position,C.DateSchedule,C.SchedTimeFrom,C.SchedTimeTo,C.WebLink,C.RequestAppoint_Id,
          C.Status
          FROM tbl_PersonnelRequestAppointment C 
          ...
          echo"<tr class='tRow' id='row".$ctr."'>";
                  ...
                  if($Status == '3'){
                    ...
                    echo '<td class="text-center"><h4><span class="badge badge-success" style ="font-weight: normal; width:110px;">Scheduled</span></h4></td>';
                  } elseif (date('Y-m-d H:i:s') <= date('Y-m-d H:i:s', strtotime("$DateSchedule $SchedTimeTo"))) {
                    echo '<td class="text-center"><h4><span class="badge badge-info" style ="font-weight: normal; width:110px;">Ongoing</span></h4></td>';
                  }else {
                    echo '<td class="text-center"><h4><span class="badge badge-warning" style ="font-weight: normal; width:110px;">Ended</span></h4></td>';
                  }
    
                  echo'   <td class="text-center">';
                  echo'       <a class="btn btn-primary btn-sm " title="View" href="PersonnelRequestAppointmentInformation.php?page='.$row[6].'">';
...
$("#hexTextBox").inputFilter(function(value) {
  ...
  if (isset($_REQUEST['PRAH'])) {
  $message = "Appointment Request has been created!";
...
<?php 
if (isset($_REQUEST['ARS'])) {
  $message = "Appointment request has been submitted!";
  displayMessage("success", "Success", $message);
}
