...
<?php
  ...
  if (isset($_GET['page'])) {
        ...
        $query = "SELECT a.Personnel_code,a.Lname,a.Fname,a.Mname,a.position,
        b.email,b.mobile,a.Personnel_Id FROM tbl_Personnel AS a,tbl_parentuser AS b WHERE a.Personnel_Id=b.pID AND Personnel_Id ='".$_GET['page']."'";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Personnel Information</li>
        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              ...
              <input value="<?php echo $personnelid ?>"
                              name="pid" id="pid" type="text" maxlenght="60" class="form-control" placeholder="" hidden>
                  <div class="row">
                          <div class="col-lg-3">
                            <div class="form-group">
                              <label class="unrequired-field">Personnel Code</label>
                              <input value="<?php echo $Personnelcode ?>"
                              name="pcode" id="pcode" type="text" maxlenght="60" class="form-control" placeholder="" required>
                            </div>
                            </div>                     
                   </div>
                ...
                <label class="unrequired-field">Last Name</label>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                              ...
                              name="position" id="position" type="text" maxlenght="60" class="form-control" placeholder="" required>
                            </div>
                            </div>
                          ...
                          <div class="col-lg-3">
                            <div class="form-group">
                              ...
                              name="email" id="email" type="text" maxlenght="60" class="form-control" placeholder="" required>
                            </div>
                            </div>
                      ...
                      <a href="personnelImport.php" class="btn btn-danger float-right" style="margin-left:10px;">
     Cancel
 </a>
...
if(isset($_POST['update'])){
  ...
  $sql1 = "SELECT a.mobile FROM tbl_parentuser AS a WHERE pID='" . $_POST['pid'] . "' AND usertype ='E' ORDER BY a.mobile DESC LIMIT 1";

  $result = mysqli_query($conn, $sql1);
  $pass_row = mysqli_fetch_assoc($result);
  $oldmobile = $pass_row['mobile'];

  $sql1 = "SELECT b.Personnel_code FROM tbl_parentuser AS a,tbl_Personnel  AS b WHERE b.Personnel_Id = a.pid AND b.Personnel_Id='" . $_POST['pid'] . "' AND a.usertype ='E' ORDER BY a.mobile DESC LIMIT 1";

  $result = mysqli_query($conn, $sql1);
  $pass_row = mysqli_fetch_assoc($result);
  $oldcode = $pass_row['Personnel_code'];

  
  if($oldmobile == $_POST['mobile'] && $oldcode == $_POST['pcode'])
  {
    $queryP1 = "UPDATE tbl_parentuser AS c
    SET c.mobile = '".$_POST['mobile']."',c.email ='".$_POST['email']."', 
    c.fullName = CONCAT('" . $_POST['lname'] . "',',','" . $_POST['fname'] . "',' ','" . $_POST['mname'] . "')
    WHERE c.pID = '" . $_POST['pid'] . "'";
    ...
    WHERE Personnel_Id = '" . $_POST['pid'] . "'";
  
    mysqli_query($conn, $insertQuery);
  
    header('Location: personnelImport.php?update');
    ...
    {
      $sql = "select a.* from tbl_Personnel as a where Personnel_code='" . $_POST['pcode'] . "'";
  ...
  if($oldcode == $_POST['pcode'])
  {
    $sql = "select a.* from tbl_parentuser as a where a.mobile='" . $_POST['mobile'] . "' AND a.usertype='E' ";
