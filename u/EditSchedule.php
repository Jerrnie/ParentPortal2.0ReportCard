...
{
  header("location: personnelAddSchedule.php");
}
...
<head>
  ...
  <title>Edit Schedule | Parent Portal</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="personnelAddSchedule.php">Add Schedule</a></li>
...
if (isset($_POST['updatesched'])) {
  ...
  header('Location: EditSchedule.php?updateChed&page='.$PersonnelSched_Id);

  }
}

if (isset($_REQUEST['updateChed'])) {
  displayMessage("success","Success","Schedule has been Update");
}


if (isset($_POST['cancelEdit'])) {
  header('Location: personnelAddSchedule.php?Editcancel&page='.$Personnel_Id);
}
