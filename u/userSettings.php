...
// $_SESSION['mobile']
  ...
  if(!isset($user_check) && !isset($password_check))
  {
    ...
    header("location: index.php");
          ...
          $sql = "sELECT  a.*, b.userID,  b.password,  b.sqAnswer,b.isSecQuestions,fullName  FROM tbl_securityquestions AS a INNER JOIN tbl_parentuser AS b ON b.sqID = a.sqID where userid = ".$user_check." LIMIT 1";
          ...
          <div class="col-lg-10">
            <div class="form-group">
              <input value="<?php echo $fullname;  ?>"
                name="first-name"required type="text" class="form-control" maxlength="60" placeholder="Full Name" id="firstname">
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-10">
            <div class="form-group">
              <div class="input-group">
                ...
                <input <?php echo "value='".$_SESSION['userEmail']. "'"; ?> name="email" type="email" maxlength="50" class="input thisNumber form-control" id="exampleInputEmail1" placeholder="Email Address" required="true">
              </div>
            </div>
          </div>
        </div>
...
if (isset($_POST['editQuestion'])) {
  ...
  if (!$chkpass) {
    ...
    $_POST['answer']=cleanData2($_POST['answer']);
...
if (isset($_POST['editPass'])) {
  ...
  if ($hasError) {
    ...
    header('Location: userSettings.php?forgotNumber='.$forgotNumber.'&forgotpass=true&passwordRequirementFailed');
    exit(1);
  }
