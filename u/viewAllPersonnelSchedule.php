...
<head>
  ...
  <title>Parent Portal | Parent Portal</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>View Personnel Schedule</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">View Personnel Schedule</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <!-- Default box -->
          <div class="card">
            <div class="card-header">
              ...
              <a href="?" type="button" class="btn btn-success add-button buttonDelete ">
                ...
                <span class=" fa fa-plus-square">&nbsp&nbsp</span>Create New Schedule
                </a>
              </p>
            </div>
            <!-- /.card-header -->
            ...
            $ctr=0;
              if (mysqli_num_rows($result1) > 0) {
                while($row = mysqli_fetch_array($result1)){
                  ...
                  $html         = $row[3];
                  $slot = $row[4];
                  $startDate    = date_format(date_create($row[7]),"M d, Y");
                  $endDate      = date_format(date_create($row[6]),"M d, Y");
                  $dateCreated  = date_format(date_create($row[5]),"M d, Y");
                  $timeEnd         = $row[8];
                  $timeStart = $row[9];
                  $status='';
          ...
          echo"<tr class='tRow' id='row".$ctr."'>";
                  ...
                  echo $endDate;
                  echo"</h6></td>";
                  if (date("Y/m/d")<date_format(date_create($row[8]),"Y/m/d")) {
                  ...
                  elseif (date("Y/m/d")>=date_format(date_create($row[8]),"Y/m/d")&&date("Y/m/d")<=date_format(date_create($row[7]),"Y/m/d")) {
                  ...
                  echo"</td>";
                   ...
                   echo'       <a href="#" class="btn delete btn-sm btn-info" title="View List of Students" id="delete'.$ctr.'" rowIdentifier="row'.$ctr.'"  value="'.$row[0].'" >';
                   echo'           <i class="fas fa-users">';
                   echo'           </i>';
                   echo'       </a>';
                   echo'   </td>';
                   }
