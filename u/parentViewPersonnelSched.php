...
<head>
  ...
  <title>View Personnel Schedule | Parent Portal </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Default box -->
          ...
          $sql ="SELECT DISTINCT D.Personnel_code, CONCAT(D.Lname,', ',D.Fname,' ', D.Mname) AS PersonnelName,D.Position,E.sectionName,
          ...
          WHERE C.userID = '".$user_check."' AND F.DateSchedule >= CAST(NOW() AS DATE) AND F.occupied = 0 AND F.status ='1'
          AND F.schoolYearID = '" . $schoolYearID . "' ORDER BY F.DateSchedule DESC";
          ...
          if ($row[10] == 0) {
            #do nothing
                  ...
                  echo'       <a class="btn btn-primary btn-sm " title="Request for Appointment" href="parentRequestAppointment.php?page='.$row[9].'">';
                  echo'           <i class="fas fa-history">';
                  echo'           </i>';
                  echo'           ';
                  echo'       </a>';
                  echo'   </td>';
