...
<?php
  ...
  require '../include/config.php';
  $page = "AdminRequestAppointHistory";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Default box -->
          ...
          WHERE C.schoolYearID = '" . $schoolYearID . "' ORDER BY C.DateSchedule";
          ...
          echo"<tr class='tRow' id='row".$ctr."'>";
                  ...
                  elseif (date("Y/m/d") < date_format(date_create($DateSchedule), "Y/m/d")) {
                    ...
                    echo '<td class="text-center"><h4><span class="badge badge-warning" style ="font-weight: normal; width:110px;">End Session</span></h4></td>';                    
                  }

                  echo'   <td class="text-center">';
                  echo'       <a class="btn btn-primary btn-sm " title="View" href="AdminRequestAppointmentInformation.php?page='.$row[6].'">';
